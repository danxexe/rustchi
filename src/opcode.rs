...
impl Opcode {    
    ...
    pub fn decode(instruction: u16) -> Opcode {
        ...
        match instruction {
            ...
            // "0000_1110_1000_00rr" => Opcode::LD(XP {}", rq(r)),
            // "0000_1110_1000_01rr" => Opcode::LD(XH {}", rq(r)),
            // "0000_1110_1000_10rr" => Opcode::LD(XL {}", rq(r)),
            // "0000_1110_1001_00rr" => Opcode::LD(YP {}", rq(r)),
            // "0000_1110_1001_01rr" => Opcode::LD(YH {}", rq(r)),
            // "0000_1110_1001_10rr" => Opcode::LD(YL {}", rq(r)),
            // "0000_1110_1010_00rr" => Opcode::LD({} XP", rq(r)),
            // "0000_1110_1010_01rr" => Opcode::LD({} XH", rq(r)),
            // "0000_1110_1010_10rr" => Opcode::LD({} XL", rq(r)),
            // "0000_1110_1011_00rr" => Opcode::LD({} YP", rq(r)),
            // "0000_1110_1011_01rr" => Opcode::LD({} YH", rq(r)),
            // "0000_1110_1011_10rr" => Opcode::LD({} YL", rq(r)),
            ...
            "0000_1100_00rr_iiii" => Opcode::TODO(format!("ADD {} 0x{:02X}", rq(r), i)),
            ...
            "0000_1100_10rr_iiii" => Opcode::TODO(format!("AND {} 0x{:02X}", rq(r), i)),

...
impl Opcode {
    ...
    pub fn decode(instruction: u16) -> Opcode {
        ...
        match instruction {
            ...
            "0000_1111_0101_iiii" => Opcode::RST(i.try_into().unwrap()),
            ...
            "0000_1100_00rr_iiii" => Opcode::ADD(r.into(), Source::U4(i.try_into().unwrap())),
            ...
            "0000_1100_10rr_iiii" => Opcode::AND(Source::Reg(r.into()), Source::U4(i.try_into().unwrap())),
...
impl fmt::Display for Opcode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::LDPX(r, i) => write!(f, "LDPX {} {}", r, i),
            Self::LBPX(i, j) => write!(f, "LBPX {} {}", i, j),
